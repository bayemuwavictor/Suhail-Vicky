...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/77fa10250d855b2fa6649.jpg" ; // SET LOGO FOR IMAGE 



global.devs = "2348118459271" // Developer Contact
...
global.userImages= process.env.USER_IMAGES|| "God's Son",
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "2348118459271";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "© God's Son" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
  ...
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "HRKU-8c790df0-440c-4de2-b8f5-32eae4f7cf19",
  HEROKU_APP_NAME:process.env.HEROKU_APP_NAME|| "Bayemuwa Victor",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "GOD'S SON",
